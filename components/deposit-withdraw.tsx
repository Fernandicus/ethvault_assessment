...
export function DepositWithdraw() {
  const { dETHContract, isConnected, balance, refreshBalances } = useWeb3();
  ...
  const setMaxDeposit = () => {
    ...
    if (Number.parseFloat(balance.eth) > 0.01) {
      const maxAmount = (Number.parseFloat(balance.eth) - 0.01).toFixed(18);
  ...
  const handleDeposit = async () => {
    ...
    try {
      ...
      if (Number.parseFloat(balance.eth) < Number.parseFloat(depositAmount)) {
        toast({
  ...
  const setMaxWithdraw = () => {
    setWithdrawAmount(balance.dEth);
  };
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      if (Number.parseFloat(balance.dEth) < Number.parseFloat(withdrawAmount)) {
        toast({
              ...
              <div>
                ...
                <div className="flex justify-between mt-2 text-sm">
                  <span className="text-lightblue-700">
                    Available: {Number.parseFloat(balance.eth).toFixed(4)} ETH
                  </span>
                  <button
          ...
          <div className="action-card">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex justify-between mt-2 text-sm">
                  <span className="text-lightblue-700">
                    Available: {Number.parseFloat(balance.dEth).toFixed(4)} dETH
                    {Number.parseFloat(balance.dEth).toFixed(4)} dETH
                  </span>
                  <button
