...
export function StakeUnstake() {
  ...
  const handleStake = async () => {
    ...
    try {
      ...
      if (Number.parseFloat(balance.dEth) < Number.parseFloat(stakeAmount)) {
        toast({
  ...
  const handleUnstake = async () => {
    ...
    try {
      ...
      if (Number.parseFloat(balance.sEth) < Number.parseFloat(unstakeAmount)) {
        toast({
  ...
  const setMaxStake = () => {
    setStakeAmount(balance.dEth);
  };

  const setMaxUnstake = () => {
    setUnstakeAmount(balance.sEth);
  };
          ...
          <div className="action-card">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex justify-between mt-2 text-sm">
                  <span className="text-lightblue-700">
                    Available: {Number.parseFloat(balance.sEth).toFixed(4)} sETH
                  </span>
                  <button
