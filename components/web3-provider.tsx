  ...
  const connectWallet = async () => {
    if (typeof window !== "undefined" && window.ethereum) {
      try {
        ...
        setBalanace((prev) => ({ ...prev, eth: directBalance }));
        ...
        try {
          ...
          const formattedDETHBal = ethers.formatEther(dETHBal);
          console.log("dETH balance:", formattedDETHBal);
          setBalanace((prev) => ({ ...prev, dEth: formattedDETHBal }));
        } catch (error) {
          console.error("Error getting dETH balance:", error);
          setBalanace((prev) => ({ ...prev, dEth: "0" }));
        }
        ...
        try {
          ...
          const formattedSETHBal = ethers.formatEther(sETHBal);
          console.log("sETH balance:", formattedSETHBal);
          setBalanace((prev) => ({ ...prev, sEth: formattedSETHBal }));
        } catch (error) {
          console.error("Error getting sETH balance:", error);
          setBalanace((prev) => ({ ...prev, sEth: "0" }));
        }
      ...
      try {
        ...
        if (provider) {
          try {
            ...
            const formattedDETHBal = ethers.formatEther(dETHBal);
            console.log("Updated dETH balance:", formattedDETHBal);
            setBalanace((prev) => ({ ...prev, dETHBalance: formattedDETHBal }));
          } catch (error) {
            console.error("Error refreshing dETH balance:", error);
            setBalanace((prev) => ({ ...prev, dETHBalance: "0" }));
          }
        }
        ...
        if (provider) {
          try {
            ...
            const formattedSETHBal = ethers.formatEther(sETHBal);
            console.log("Updated sETH balance:", formattedSETHBal);
            setBalanace((prev) => ({ ...prev, sETHBalance: formattedSETHBal }));
          } catch (error) {
            console.error("Error refreshing sETH balance:", error);
            setBalanace((prev) => ({ ...prev, sETHBalance: "0" }));
          }
        }
      } catch (error) {
