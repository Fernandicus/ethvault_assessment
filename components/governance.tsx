...
export function Governance() {
  ...
  const createProposal = async () => {
    ...
    try {
      ...
      if (Number.parseFloat(balance.sEth) < 1) {
        toast({
  ...
  const voteOnProposal = async (proposalId: number, support: boolean) => {
    ...
    try {
      ...
      if (Number.parseFloat(balance.sEth) <= 0) {
        toast({
      ...
      const proposalData = await governanceContract.getProposalDetails(
        proposalId
      );
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {Number.parseFloat(balance.sEth) < 1 && (
                  <Alert
                    variant="warning"
